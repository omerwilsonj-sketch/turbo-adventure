...
>
> **52 exercises** across 7 movement categories, with 3 tiers each (Beginner → Intermediate → Advanced).

---

## Table of Contents

1. [Squat Pattern (8 exercises)](#1-squat-pattern)
2. [Hinge Pattern (8 exercises)](#2-hinge-pattern)
3. [Upper Body Push (8 exercises)](#3-upper-body-push)
4. [Upper Body Pull (7 exercises)](#4-upper-body-pull)
5. [Core / Anti-Rotation (8 exercises)](#5-core--anti-rotation)
6. [Full Body / Power (6 exercises)](#6-full-body--power)
7. [Cardio / Conditioning (7 exercises)](#7-cardio--conditioning)
8. [Exercise Substitution Matrix](#8-exercise-substitution-matrix)
...
| **Common Mistakes** | Heels lifting off floor (tighten calves or widen stance). Knees collapsing inward (cue "spread the floor" with feet). Rounding lower back (brace core). |
...
| **Common Mistakes** | Elbows flaring out (tuck them). Weight drifting away from chest (pull it in). |
| **Progression** | Increase weight. Front Squat. |

### 1.3 Front Squat (Dumbbell)
| Field | Detail |
|---|---|
| **Tier** | Intermediate |
...
| **Common Mistakes** | Elbows dropping (cue "show your armpits to the mirror"). Leaning forward (mobility issue — elevate heels on a plate). |
...
| **Breathing** | Inhale down, exhale up. |
| **Common Mistakes** | Front knee traveling past the toes excessively (move front foot farther forward). Weight on back leg (should be 90% on front leg). |
...
| **Common Mistakes** | Lunging too short (front knee travels past toes). Leaning forward (keep chest tall). |
...
| **Common Mistakes** | Stride too short (knee over-toes). Stride too long (loss of balance). |
...
| **Common Mistakes** | Using the back leg to push off (rest the back foot gently, no push). Rounding forward (chest up). |
| **Progression** | Increase box height. Add weight. Explosive Step-Up (drive knee up). |

### 1.8 Pistol Squat (Assisted)
| Field | Detail |
|---|---|
| **Tier** | Advanced |
...
| **Breathing** | Inhale down, exhale up. |
| **Common Mistakes** | Losing balance (use more assist). Heel lifting (stretch ankle or use a wedge). |
...
| **Common Mistakes** | Rounding the lower back (cue "proud chest"). Lifting with the lower back instead of legs (initiate with leg drive). |
...
| **Breathing** | Inhale on descent. Exhale on ascent. |
| **Common Mistakes** | Bending the knees too much (turns into a squat). Dumbbells drifting away from the body (drag them up your thighs). |
| **Progression** | Single-Leg RDL. Deficit RDL. |

### 2.3 Single-Leg Romanian Deadlift
| Field | Detail |
|---|---|
| **Tier** | Advanced |
...
| **Breathing** | Inhale down. Exhale up. |
| **Common Mistakes** | Rotating the hips open (keep hips square to the floor). Rounding the back too early (keep chest up as long as possible). |
| **Progression** | Increase weight. Stand on a pad (unstable surface). |

### 2.4 Kettlebell Swing
| Field | Detail |
|---|---|
| **Tier** | Beginner–Intermediate |
...
| **Common Mistakes** | Squatting the swing (it's a hinge, not a squat). Leading with the arms (hips drive). KB going above shoulder height (dangerous for shoulders). |
...
| **Breathing** | Inhale on descent. Exhale on ascent. |
| **Common Mistakes** | Rounding the lower back. Bending the knees too much. |
...
| **Common Mistakes** | Hyperextending the lower back (squeeze glutes, don't arch). Feet too close or too far. |
| **Progression** | Single-Leg Hip Thrust. Increasing weight. |

### 2.7 Reverse Hyperextension (Floor)
| Field | Detail |
|---|---|
| **Tier** | Beginner–Intermediate |
...
| **Common Mistakes** | Using momentum (control the descent). Arching the upper back (keep chest on the bench). |
| **Progression** | Add ankle weights. |

### 2.8 Band Glute Bridge
| Field | Detail |
|---|---|
| **Tier** | Beginner |
| **Target** | Glutes |
...
| **Breathing** | Exhale up. Inhale down. |
| **Common Mistakes** | Losing band tension. Not squeezing glutes (lower back takes over). |
...
| **Breathing** | Inhale down. Exhale up. |
| **Common Mistakes** | Flaring elbows (keep 45°). Sagging hips (brace core). Piking hips up. |
...
| **Breathing** | Inhale down. Exhale up. |
| **Common Mistakes** | Sagging hips (cue "squeeze glutes and brace abs"). Head dropping or looking up (neutral neck). Elbows wide (tuck to 45°). |
...
| **Breathing** | Inhale down. Exhale up. |
| **Common Mistakes** | Loss of core tension (hips sag as you go deeper). Wrist pain (use push-up handles). |
...
| **Breathing** | Inhale on descent. Exhale on ascent. |
| **Common Mistakes** | Dumbbells touching at the top (keeps tension off the chest — stop with a fist-width gap). Elbows flaring (tuck). |
...
| **Breathing** | Inhale down. Exhale up. |
| **Common Mistakes** | Bench angle too steep (>45° shifts load to shoulders). Dumbbells traveling behind the face at the bottom. |
| **Progression** | Increase weight. Dumbbell Floor Press. |

### 3.6 Dumbbell Shoulder Press
| Field | Detail |
|---|---|
| **Tier** | Intermediate |
...
| **Breathing** | Exhale up. Inhale down. |
| **Common Mistakes** | Arching the lower back excessively (brace core). Dumbbells drifting in front of the face (they should go straight up and slightly back). |
...
| **Common Mistakes** | Not using the legs enough (it becomes a strict press). Dipping too deep (quarter squat only). |
| **Progression** | Push Jerk (split stance catch). |

### 3.8 Triceps Pushdown (Band)
| Field | Detail |
|---|---|
| **Tier** | Beginner–Intermediate |
| **Target** | Triceps |
...
| **Common Mistakes** | Elbows flaring away from the body. Using shoulders instead of triceps. |
...
| **Common Mistakes** | Using the lower back to rock the weight (keep torso still). Shrugging up to the ears (depress shoulder blades). |
| **Progression** | Double the band. Dumbbell Row. |

### 4.2 Dumbbell Row (Bent-Over)
| Field | Detail |
|---|---|
| **Tier** | Intermediate |
...
| **Common Mistakes** | Twisting the torso (keep hips and shoulders square). Rounding the back (chin tucked, chest open). Using too much biceps (lead with the elbow, not the hand). |
...
| **Common Mistakes** | Hips rotating open (they should stay parallel to the floor). Dumbbell not coming high enough (pull to the hip, not the chest). |
| **Progression** | Push-Up + Row (one rep each). Add weight. Knee push-up variation. |

### 4.4 Pull-Up (Assisted)
| Field | Detail |
|---|---|
| **Tier** | Intermediate |
...
| **Breathing** | Exhale on the pull. Inhale on the lower. |
| **Common Mistakes** | Kipping (keep the body still — strict only). Not reaching full extension at the bottom. Chin not clearing the bar (full ROM). |
...
| **Breathing** | Exhale on the pull. Inhale on the lower. |
| **Common Mistakes** | Same as pull-ups — keep strict form, no kipping. |
| **Progression** | Weighted Chin-Up. Archer Chin-Up. |

### 4.6 TRX / Band Inverted Row
| Field | Detail |
|---|---|
| **Tier** | Beginner–Intermediate |
| **Target** | Mid-back, lats, biceps |
...
| **Breathing** | Exhale on the pull. Inhale on the lower. |
| **Common Mistakes** | Sagging hips (brace core). Elbows wide (tuck to 45°). Not pulling to the chest. |
...
| **Breathing** | Exhale on the pull. Inhale on the release. |
| **Common Mistakes** | Pulling to the chin (should be to the forehead/face level). Using too heavy a band (lose control). |
...
| **Common Mistakes** | Hips sagging (squeeze glutes). Hips piking up (drop hips toward the floor). Looking forward (neutral neck). |
...
| **Common Mistakes** | Lower back arching (press it into the floor — if it arches, reduce ROM). Moving too fast (control is everything). |
...
| **Common Mistakes** | Pulling the head (hands are pillows — light touch). Moving too fast (quality over speed). Feet not extending far enough. |
...
| **Common Mistakes** | Hips sagging (lift them higher). Head dropping (align with spine). Top hip rotating forward (keep stacked). |
...
| **Common Mistakes** | Hips sagging as feet go wide (tighten core). Bouncing the hips. |
| **Progression** | Increase speed. Add a push-up before the jack. |

### 5.6 Hanging Knee Raise
| Field | Detail |
|---|---|
| **Tier** | Advanced |
...
| **Breathing** | Exhale up. Inhale down. |
| **Common Mistakes** | Swinging the body (controlled tempo only). Using momentum (if you rock, pause and restart). |
...
| **Breathing** | Exhale on each twist. |
| **Common Mistakes** | Twisting the spine (rotate from the ribcage, not the lower back). Feet dropping to floor (keep them steady). |
| **Progression** | Add weight. Feet elevated. Slower tempo with pause. |

### 5.8 Hollow Body Hold
| Field | Detail |
|---|---|
| **Tier** | Intermediate |
...
| **Common Mistakes** | Lower back lifting (press it down HARD). Head tilted back (chin tucked). Arms sagging (reach past the head). |
...
| **Common Mistakes** | Pressing before standing (sequencing is wrong). Squatting shallow. |
...
| **Common Mistakes** | Pulling with the arms only (drive with legs). Catching the bell on the shoulder hard (absorb it). |
...
| **Common Mistakes** | Pressing the weight instead of punching through. Squatting the catch. |
...
| **Common Mistakes** | Skipping the push-up (maintain full ROM). Sagging core in plank. Lazy jump (explosive finish). |
| **Progression** | Burpee with Tuck Jump. Burpee Box Jump Over. Weight Vest. |

### 6.5 Burpee Box Jump Over
| Field | Detail |
|---|---|
| **Tier** | Advanced |
...
| **Common Mistakes** | Hesitating between burpee and jump (make it one fluid combo). Jumping too short (use a lower box). |
...
| **Common Mistakes** | Knees dragging on the floor (keep them up). Moving the same side hand + foot (opposite side always). |
...
| **Common Mistakes** | Hips sagging (core loose). Feet slapping the floor (quiet, controlled steps). |
...
| **Common Mistakes** | Leaning backward (stay tall). Landing heavy (soft feet). Knees not reaching waist height. |
| **Progression** | A-Skip. High Knees with resistance band at ankles. |

### 7.3 Battle Ropes (Slams)
| Field | Detail |
|---|---|
| **Tier** | Intermediate |
...
| **Common Mistakes** | Too much arm (use the whole body). Standing too upright (athletic stance). |
...
| **Common Mistakes** | Jumping too early (set the jump). Stomping the landing (absorb the landing quietly). Stepping back off the box instead of stepping down. |
...
| **Common Mistakes** | No arm swing (use arms for momentum). Hard landings (absorb through the knee and hip). |
...
| **Breathing** | Breathe rhythmically. |
| **Common Mistakes** | Jumping too high (waste of energy). Flaring elbows (keep them close). Looking at feet (look forward). |
| **Progression** | Double Under (rope passes twice per jump). Single-Leg Jumps. Running in Place. |

### 7.7 Marching (High-Step)
| Field | Detail |
|---|---|
| **Tier** | Beginner |
...
| **Breathing** | Breathe steadily. |
| **Common Mistakes** | Leaning backward. Lifting the knee with momentum (controlled). |
| **Progression** | Faster pace. Weighted Marching (ankle weights). Marching with high arms. |

---

## 8. Exercise Substitution Matrix

For travel, limited equipment, or injury — find a replacement.

| If You Can't Do | Sub with | Change |
|---|---|---|
| Pull-Up | Band Row, Inverted Row | Same back stimulus, easier load |
| Box Jump | Step-Up, Jump Squat | Reduce impact |
| Kettlebell Swing | DB Deadlift + Explosive Hip Hinge | Same hip pattern |
| Bulgarian Split Squat | Reverse Lunge, Step-Up | Similar unilateral work |
| Battle Ropes | High Knees, Mountain Climbers | Same cardio intensity |
| Dumbbell Snatch | DB Clean + Press (2 moves) | Same general stimulus |
| Hanging Knee Raise | Dead Bug, Lying Leg Raise | Same core engagement |
| Pistol Squat | Assisted Pistol, Bulgarian Split Squat | Same movement intent |

---

## Index: All 52 Exercises

| # | Exercise | Category | Tier | Equipment |
|---|---|---|---|---|
| 1 | Bodyweight Squat | Squat | Beginner | None |
| 2 | Goblet Squat | Squat | Beginner | Dumbbell/KB |
| 3 | Front Squat (DB) | Squat | Intermediate | Dumbbells |
| 4 | Bulgarian Split Squat | Squat | Advanced | Dumbbells (opt), Bench |
| 5 | Reverse Lunge | Squat | Beginner-Int | Dumbbells (opt) |
| 6 | Forward Lunge | Squat | Intermediate | Dumbbells |
| 7 | Box Step-Up | Squat | Beginner-Int | Box, Dumbbells (opt) |
| 8 | Pistol Squat (Assisted) | Squat | Advanced | Assistance |
| 9 | DB Deadlift | Hinge | Beginner | Dumbbells |
| 10 | Romanian Deadlift | Hinge | Intermediate | Dumbbells |
| 11 | Single-Leg RDL | Hinge | Advanced | Dumbbells |
| 12 | Kettlebell Swing | Hinge | Beginner-Int | Kettlebell |
| 13 | Good Morning | Hinge | Intermediate | Dumbbell/Barbell |
| 14 | Hip Thrust | Hinge | Intermediate | Bench, DB (opt) |
| 15 | Reverse Hyperextension | Hinge | Beginner-Int | Bench |
| 16 | Band Glute Bridge | Hinge | Beginner | Resistance band |
| 17 | Incline Push-Up | Push | Beginner | Bench/Box |
| 18 | Full Push-Up | Push | Intermediate | None |
| 19 | Deficit Push-Up | Push | Advanced | Blocks/Handles |
| 20 | DB Bench Press | Push | Intermediate | Dumbbells, Bench |
| 21 | Incline DB Press | Push | Int-Adv | Dumbbells, Bench |
| 22 | DB Shoulder Press | Push | Intermediate | Dumbbells |
| 23 | Push Press | Push | Advanced | Dumbbells |
| 24 | Triceps Pushdown (Band) | Push | Beginner-Int | Resistance band |
| 25 | Band Row | Pull | Beginner | Resistance band |
| 26 | DB Row (Bent-Over) | Pull | Intermediate | Dumbbell, Bench |
| 27 | Renegade Row | Pull | Advanced | Dumbbells |
| 28 | Pull-Up (Assisted) | Pull | Intermediate | Bar, Band |
| 29 | Chin-Up | Pull | Int-Adv | Bar |
| 30 | TRX/Band Inverted Row | Pull | Beginner-Int | TRX/Bar |
| 31 | Face Pull (Band) | Pull | Beginner-Int | Resistance band |
| 32 | Plank | Core | Beginner | Mat |
| 33 | Dead Bug | Core | Beginner-Int | Mat |
| 34 | Bicycle Crunch | Core | Intermediate | Mat |
| 35 | Side Plank | Core | Intermediate | Mat |
| 36 | Plank Jacks | Core | Intermediate | Mat |
| 37 | Hanging Knee Raise | Core | Advanced | Pull-up bar |
| 38 | Russian Twist | Core | Intermediate | DB/Med Ball (opt) |
| 39 | Hollow Body Hold | Core | Intermediate | Mat |
| 40 | DB Thruster | Full Body | Intermediate | Dumbbells |
| 41 | DB Clean | Full Body | Int-Adv | Dumbbells |
| 42 | DB Snatch | Full Body | Advanced | Dumbbell |
| 43 | Burpee | Full Body | Beginner-Int | None |
| 44 | Burpee Box Jump Over | Full Body | Advanced | Box |
| 45 | Bear Crawl | Full Body | Intermediate | Mat (opt) |
| 46 | Mountain Climbers | Cardio | Beginner-Int | Mat |
| 47 | High Knees | Cardio | Beginner-Int | None |
| 48 | Battle Ropes (Slams) | Cardio | Intermediate | Battle ropes |
| 49 | Box Jumps | Cardio | Int-Adv | Box |
| 50 | Skater Hops | Cardio | Intermediate | None |
| 51 | Jump Rope (Basic) | Cardio | Beginner-Int | Jump rope |
| 52 | Marching (High-Step) | Cardio | Beginner | None |
